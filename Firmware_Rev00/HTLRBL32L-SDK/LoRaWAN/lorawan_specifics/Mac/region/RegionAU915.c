...
void RegionAU915InitDefaults( InitDefaultsParams_t* params )
{
	...
	case INIT_TYPE_INIT:
	{
		...
		//This config is to enable the channels used. Here is configured to use only the first seven channels.
		//This masks setup is going to depend of the config of your receiver (which channels are enabled).
		//0-7
