...
//            NvmCtx.ChannelsDefaultMask[5] = 0x0000;
			...
			NvmCtx.ChannelsDefaultMask[0] = 0x00FF; //0 - 15
			NvmCtx.ChannelsDefaultMask[1] = 0x0000; //15 - 31
			NvmCtx.ChannelsDefaultMask[2] = 0x0000; //32 - 47
			NvmCtx.ChannelsDefaultMask[3] = 0x0000; //48 - 63
			NvmCtx.ChannelsDefaultMask[4] = 0x0000; //64 - 79
			NvmCtx.ChannelsDefaultMask[5] = 0x0000; //80 - 96?
